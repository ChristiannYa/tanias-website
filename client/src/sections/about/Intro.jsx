    ...
    return (
        <section className="flex flex-col justify-center items-center screen800">
            <div className="font-fCormorant text-fc-1 text-center text-2xl font-light w-full">
                ...
                <p>
                    I have a <span className="underlined-1">passion</span> for
                    capturing candid, authentic moments that tell a story, and I
                ...
                <p>
                    Take a look around and explore my galleries. I am excited to
            ...
            <div className="colflex-center screen400">
                ...
                <p className="small-text text-fc-1 text-center text-lg">
                    &quot;Photography is the art of freezing time, keeping the
                    essence of that very moment beyond life.&quot; <br />- Tania
                    Gutti
                </p>
                <div className="my-4">
