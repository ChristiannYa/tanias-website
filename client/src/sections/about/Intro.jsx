    ...
    <section className='colflex-center screen800'>
      ...
      <div className='colflex-center screen400'>
        ...
        <p className='small-text text-fc-3 text-center text-lg'>
          &quot;Photography is the art of freezing time, keeping the essence of that very moment beyond life.&quot; <br/>
          - Tania Gutti
        </p>
        <div className='my-4'>
          ...
          <img src={icons.ppa} alt="Professional Photographers of America" className='w-32'/>
        </div>
      </div>
    </section>
  );
